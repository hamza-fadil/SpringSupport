...
public class HibernateSearchService {
    ...
    @Transactional
    public List<Ticket> fuzzySearch(String searchTerm) {

        FullTextEntityManager fullTextEntityManager = Search.getFullTextEntityManager(centityManager);
        QueryBuilder qb = fullTextEntityManager.getSearchFactory().buildQueryBuilder().forEntity(Ticket.class).get();
        ...
        try {
        	TicketList = jpaQuery.getResultList();
